...
/**
 * PostCategory Resource for the CMS Framework Blog Module.
 *
 * This resource class transforms post category model instances into JSON API responses,
...
/**
 * JSON resource for post category data transformation.
 *
 * Transforms post category model instances into properly formatted JSON responses
...
class PostCategoryResource extends JsonResource
{
     ...
     *
     * Converts the post category model instance into an array suitable for JSON API responses.

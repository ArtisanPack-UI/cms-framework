...
/**
 * PostTag Request for the CMS Framework Blog Module.
 *
 * This form request handles validation and authorization for post tag-related
...
/**
 * Form request for post tag validation and authorization.
 *
 * Provides validation rules and authorization logic for post tag creation
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('post_tags', 'slug')->ignore($id),
            ],

...
{
	/**
	 * Use factory for model creation in tests
	 *
	 * @since 1.0.0
	 */
	use HasFactory;
	 ...
	 */
	public function getValueAttribute( $value ) // Renamed from getOptionAttribute
	{
	 ...
	 * @return void
	 */
	public function setValueAttribute( $value ) // Renamed from setOptionAttribute
	{

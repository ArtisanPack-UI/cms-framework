...
class MediaManager implements MediaManagerInterface
{
    ...
    public function update(int $mediaId, array $data): ?Media
    {
        ...
        if (isset($data['is_decorative'])) {
            ...
            if ($updateData['is_decorative'] === true) {
        ...
        if (isset($data['alt_text']) && (! isset($updateData['is_decorative']) || $updateData['is_decorative'] === false)) {
            $updateData['alt_text'] = $security->sanitizeText($data['alt_text']);
        } elseif (! isset($data['alt_text']) && isset($updateData['is_decorative']) && $updateData['is_decorative'] === false) {

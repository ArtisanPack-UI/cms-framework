...
test( 'ap_register_role helper function creates a new role', function (): void {
...
test( 'ap_register_role helper function returns existing role', function (): void {
...
test( 'ap_register_permission helper function creates a new permission', function (): void {
...
test( 'ap_register_permission helper function returns existing permission', function (): void {
...
test( 'ap_add_permission_to_role helper function adds permission to role', function (): void {
...
test( 'ap_add_permission_to_role helper function throws exception for non-existent role', function (): void {
...
test( 'ap_add_permission_to_role helper function throws exception for non-existent permission', function (): void {
...
test( 'helper functions work together to create complete role-permission setup', function (): void {
...
test( 'helper functions handle duplicate permission assignment gracefully', function (): void {
...
test( 'helper functions are globally available', function (): void {
...
test( 'helper functions use app container correctly', function (): void {

...
test('permission manager can register a new permission', function () {
...
test('permission manager returns existing permission if already registered', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager can register multiple permissions', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager register method works with app container', function () {
...
test('permission manager handles empty slug gracefully', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager handles empty name gracefully', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager register returns same instance for duplicate calls', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager works with special characters in slug and name', function () {
    $permissionManager = new PermissionManager();
...
test('permission manager registers permissions with long names', function () {
    $permissionManager = new PermissionManager();

...
test( 'role manager can register a new role', function (): void {
...
test( 'role manager returns existing role if already registered', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager can add permission to role', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager throws exception when role not found for adding permission', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager throws exception when permission not found for adding to role', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager can add multiple permissions to same role', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager does not duplicate permissions when adding same permission twice', function (): void {
    $roleManager = new RoleManager;
...
test( 'role manager register method works with app container', function (): void {
...
test( 'role manager addPermissionToRole method works with app container', function (): void {
    $roleManager = app( RoleManager::class );

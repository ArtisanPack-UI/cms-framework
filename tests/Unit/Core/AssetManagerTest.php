 ...
 * ADMIN CONTEXT
 */
test('admin: enqueuing a single asset registers it with correct properties', function () {
...
test('admin: enqueuing multiple assets aggregates them', function () {
    $assets = app(AssetManager::class);
...
test('admin: enqueuing same handle twice results in last registration winning', function () {
    $assets = app(AssetManager::class);
 ...
 * PUBLIC CONTEXT
 */
test('public: enqueuing assets registers and lists them', function () {
    $assets = app(AssetManager::class);
 ...
 * AUTH CONTEXT
 */
test('auth: enqueuing assets registers and lists them', function () {
    $assets = app(AssetManager::class);

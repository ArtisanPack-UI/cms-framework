...
test( 'permission can be created with fillable attributes', function (): void {
...
test( 'permission has many-to-many relationship with roles', function (): void {
    $permission = Permission::create( [
        'name' => 'Edit Content',
        'slug' => 'edit-content',
    ] );
...
test( 'permission fillable attributes are correct', function (): void {
...
test( 'permission can be detached from roles', function (): void {
    $permission = Permission::create( [
        'name' => 'Delete Posts',
        'slug' => 'delete-posts',
    ] );
...
test( 'permission relationship works both ways', function (): void {
    $permission = Permission::create( [

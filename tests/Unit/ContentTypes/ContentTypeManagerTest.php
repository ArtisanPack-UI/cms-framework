...
test('register content type adds content type to filter hook', function () {
...
test('get registered content types returns database content types', function () {
    $manager = new ContentTypeManager;
...
test('get content type returns correct content type by slug', function () {
    $manager = new ContentTypeManager;
...
test('get content type returns null for non existent content type', function () {
    $manager = new ContentTypeManager;
...
test('create content type creates new content type in database', function () {
    $manager = new ContentTypeManager;
...
test('update content type updates existing content type', function () {
    $manager = new ContentTypeManager;
...
test('update content type throws exception for non existent content type', function () {
    $manager = new ContentTypeManager;
...
test('delete content type deletes existing content type', function () {
    $manager = new ContentTypeManager;
...
test('delete content type returns false for non existent content type', function () {
    $manager = new ContentTypeManager;
...
test('content type exists returns true for existing content type', function () {
    $manager = new ContentTypeManager;
...
test('content type exists returns false for non existent content type', function () {
    $manager = new ContentTypeManager;
...
test('content type manager works with app container', function () {
...
test('registered content types merges database and filtered content types', function () {
    $manager = new ContentTypeManager;

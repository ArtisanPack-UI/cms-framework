...
test('register field adds custom field to filter hook', function () {
...
test('get fields for content type returns correct fields', function () {
    $manager = new CustomFieldManager;
...
test('create field creates custom field in database', function () {
    $manager = new CustomFieldManager;
...
test('update field updates custom field data', function () {
    $manager = new CustomFieldManager;
...
test('delete field removes custom field and columns', function () {
    $manager = new CustomFieldManager;
...
test('add column to table adds column with correct type', function () {
    $manager = new CustomFieldManager;
...
test('add column to table respects required constraint', function () {
    $manager = new CustomFieldManager;

    Schema::create('test_required', function ($table) {
        $table->id();
        $table->timestamps();
    });
...
test('add column to table sets default value', function () {
    $manager = new CustomFieldManager;
...
test('remove column from table removes column', function () {
    $manager = new CustomFieldManager;

    Schema::create('test_remove', function ($table) {
        $table->id();
...
test('add column does not duplicate if column already exists', function () {
    $manager = new CustomFieldManager;

    Schema::create('test_duplicate', function ($table) {
        $table->id();
...
test('generate migration creates valid migration file', function () {
    $manager = new CustomFieldManager;
...
test('custom field manager works with app container', function () {
...
test('update field handles content type changes', function () {
    $manager = new CustomFieldManager;
    ...
    Schema::create('test_posts_ct', function ($table) {
        $table->id();
        $table->timestamps();
    });

    Schema::create('test_pages_ct', function ($table) {
        $table->id();
        $table->timestamps();
    });

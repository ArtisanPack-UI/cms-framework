...
test( 'user can have roles attached', function (): void {
    $user = TestUser::create( [
        'name'     => 'Jane Doe',
...
test( 'hasRole method returns true when user has the role', function (): void {
    $user = TestUser::create( [
        'name'     => 'Bob Smith',
...
test( 'hasRole method returns false when user does not have the role', function (): void {
    $user = TestUser::create( [
        'name'     => 'Alice Johnson',
...
test( 'hasPermissionTo method returns true when user has permission through role', function (): void {
    $user = TestUser::create( [
        'name'     => 'Charlie Brown',
...
test( 'hasPermissionTo method returns false when user does not have permission', function (): void {
    $user = TestUser::create( [
        'name'     => 'David Wilson',
...
test( 'user can have multiple roles with different permissions', function (): void {
    $user = TestUser::create( [
        'name'     => 'Eva Green',
...
test( 'hasPermissionTo works with role that has multiple permissions', function (): void {
    $user = TestUser::create( [
        'name'     => 'Frank Miller',

...
test( 'page can be created with required attributes', function (): void {
...
test( 'page has parent child relationship', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page children are ordered by order column', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page ancestors returns all parent pages', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page descendants returns all child pages recursively', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page siblings returns pages with same parent', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'breadcrumb attribute generates correct trail', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'depth attribute returns correct hierarchy level', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'permalink attribute generates hierarchical url', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'draft scope returns only draft pages', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'by author scope filters pages by author', function (): void {
...
test( 'top level scope returns pages without parents', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'by template scope filters pages by template', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'is published method returns true for published pages', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'is published method returns false for draft pages', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page has categories relationship', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',
...
test( 'page has tags relationship', function (): void {
    $user = TestUser::create( [
        'name'     => 'Test Author',
        'email'    => 'author@example.com',
        'password' => 'password',

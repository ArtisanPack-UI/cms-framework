...
test( 'can create notification', function (): void {
...
test( 'notification has correct fillable attributes', function (): void {
...
test( 'notification casts type to NotificationType enum', function (): void {
    $notification = Notification::factory()->create( [
...
test( 'notification casts metadata to array', function (): void {
...
test( 'notification casts send_email to boolean', function (): void {
    $notification = Notification::factory()->create( [
        'send_email' => true,
    ] );
...
test( 'notification can be attached to users', function (): void {
    $notification = Notification::factory()->create();
...
test( 'notification user pivot includes read and dismissed status', function (): void {
    $notification = Notification::factory()->create();
    $user         = User::factory()->create();
...
test( 'scopeUnreadForUser returns only unread notifications for user', function (): void {
    $user               = User::factory()->create();
...
test( 'scopeUnreadForUser excludes dismissed notifications', function (): void {
    $user         = User::factory()->create();
    $notification = Notification::factory()->create();
...
test( 'scopeReadForUser returns only read notifications for user', function (): void {
    $user               = User::factory()->create();
    $readNotification   = Notification::factory()->create();
    $unreadNotification = Notification::factory()->create();
...
test( 'scopeNotDismissedForUser returns only non-dismissed notifications', function (): void {
    $user                  = User::factory()->create();
...
test( 'scopeOfType filters notifications by type', function (): void {
...
test( 'factory creates notification with default values', function (): void {
    $notification = Notification::factory()->create();
...
test( 'factory error state creates error notification', function (): void {
    $notification = Notification::factory()->error()->create();

    expect( $notification->type )->toBe( NotificationType::Error );
} );

test( 'factory warning state creates warning notification', function (): void {
    $notification = Notification::factory()->warning()->create();

    expect( $notification->type )->toBe( NotificationType::Warning );
} );

test( 'factory success state creates success notification', function (): void {
    $notification = Notification::factory()->success()->create();

    expect( $notification->type )->toBe( NotificationType::Success );
} );

test( 'factory info state creates info notification', function (): void {

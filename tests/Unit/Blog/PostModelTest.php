...
test('post can be created with required attributes', function () {
...
test('by author scope filters posts by author', function () {
...
test('by category scope filters posts by category', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('by tag scope filters posts by tag', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('by year scope filters posts by year', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('by month scope filters posts by month and year', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('by date scope filters posts by specific date', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('is published method returns true for published posts', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('is published method returns false for draft posts', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('is published method returns false for scheduled posts', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('post has author relationship', function () {
    $user = TestUser::create([
        'name' => 'John Doe',
...
test('post has categories relationship', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('permalink attribute generates correct url', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('post casts published at as datetime', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',
...
test('post casts metadata as array', function () {
    $user = TestUser::create([
        'name' => 'Test Author',
        'email' => 'author@example.com',
        'password' => 'password',

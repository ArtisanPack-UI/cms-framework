...
it( 'can list all media tags', function () {
    ...
    $response = $this->getJson( '/api/cms/media-tags' );
...
it( 'can update a media tag', function () {
    ...
    $response = $this->putJson( "/api/cms/media-tags/{$this->mediaTag->id}", $updateData );
...
it( 'can delete a media tag', function () {
    ...
    $response = $this->deleteJson( "/api/cms/media-tags/{$this->mediaTag->id}" );

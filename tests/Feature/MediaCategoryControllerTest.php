...
it( 'can list all media categories', function () {
	...
	$response = $this->getJson( '/api/cms/media-categories' );
...
it( 'can show a specific media category', function () {
	...
	$response = $this->getJson( "/api/cms/media-categories/{$this->mediaCategory->id}" );
...
it( 'can update a media category', function () {
	...
	$response = $this->putJson( "/api/cms/media-categories/{$this->mediaCategory->id}", $updateData );
...
it( 'can delete a media category', function () {
	...
	$response = $this->deleteJson( "/api/cms/media-categories/{$this->mediaCategory->id}" );
...
it( 'validates required fields when creating a media category', function () {
	// Act as admin with Sanctum
	Sanctum::actingAs( $this->admin );
	$response = $this->postJson( '/api/cms/media-categories', [] );

...
test( 'user can access system notifications relationship', function (): void {
...
test( 'user can access notification preferences', function (): void {
    $user = User::factory()->create();
...
test( 'user can get notification preference for type', function (): void {
    $user       = User::factory()->create();
...
test( 'shouldReceiveNotification returns true when no preference exists', function (): void {
    $user = User::factory()->create();

    expect( $user->shouldReceiveNotification( 'test.type' ) )->toBeTrue();
} );

test( 'shouldReceiveNotification respects user preference', function (): void {
    $user = User::factory()->create();
    NotificationPreference::factory()->create( [
        'user_id'           => $user->id,
        'notification_type' => 'test.type',
...
test( 'shouldReceiveNotificationEmail returns true when no preference exists', function (): void {
    $user = User::factory()->create();

    expect( $user->shouldReceiveNotificationEmail( 'test.type' ) )->toBeTrue();
} );

test( 'shouldReceiveNotificationEmail respects email preference', function (): void {
    $user = User::factory()->create();
    NotificationPreference::factory()->create( [
        'user_id'           => $user->id,
        'notification_type' => 'test.type',
...
test( 'user can dismiss notification', function (): void {
    $user         = User::factory()->create();
    $notification = Notification::factory()->create();
...
test( 'user can dismiss all notifications', function (): void {
    $user          = User::factory()->create();
    $notification1 = Notification::factory()->create();
    $notification2 = Notification::factory()->create();

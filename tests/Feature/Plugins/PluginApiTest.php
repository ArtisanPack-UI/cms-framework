...
describe('Plugin API - Index', function () {
    it('returns list of all plugins', function () {
...
describe('Plugin API - Show', function () {
    it('returns specific plugin details', function () {
        $this->actingAs($this->admin);
    ...
    it('returns 404 for non-existent plugin', function () {
        $this->actingAs($this->admin);
...
describe('Plugin API - Activate', function () {
    ...
    it('returns error when activating non-existent plugin', function () {
        $this->actingAs($this->admin);
...
describe('Plugin API - Deactivate', function () {
...
describe('Plugin API - Delete', function () {
    it('can delete a plugin', function () {
        $this->actingAs($this->admin);
...
describe('Plugin API - Check Updates', function () {
    it('returns update information', function () {
        $this->actingAs($this->admin);
...
describe('Plugin API - Permission Checks', function () {

...
describe('Plugin Installation', function () {
    it('can create a plugin directory manually for testing', function () {
...
describe('Plugin Activation', function () {
    ...
    it('throws exception when activating non-existent plugin', function () {
        expect(fn () => $this->manager->activate('non-existent'))
            ->toThrow(PluginNotFoundException::class);
    });

    it('activates plugin with migrations', function () {
...
describe('Plugin Deactivation', function () {
    it('can deactivate an active plugin', function () {
    ...
    it('throws exception when deactivating non-existent plugin', function () {
        expect(fn () => $this->manager->deactivate('non-existent'))
            ->toThrow(PluginNotFoundException::class);
    });
});

describe('Plugin Deletion', function () {
    it('can delete an inactive plugin', function () {
        // Setup: Install plugin
        File::copyDirectory(
            $this->testPluginsPath.'/valid-plugin',
            $this->pluginsPath.'/valid-plugin'
    ...
    it('deactivates plugin before deletion if active', function () {
    ...
    it('can delete plugin without removing files', function () {
        // Setup: Install plugin
        File::copyDirectory(
            $this->testPluginsPath.'/valid-plugin',
            $this->pluginsPath.'/valid-plugin'
    ...
    it('throws exception when deleting non-existent plugin', function () {
        expect(fn () => $this->manager->delete('non-existent'))
            ->toThrow(PluginNotFoundException::class);
    });
});

describe('Active Plugins Loading', function () {
    it('loads all active plugins on boot', function () {
